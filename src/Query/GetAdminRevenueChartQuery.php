...
#[AsMessageHandler]
final readonly class GetAdminRevenueChartQuery
{
    ...
    public function __invoke(GetAdminRevenueChart $query): GetAdminRevenueChartResult
    {
        $now = $this->clock->now();
        $data = $this->paymentRepository->getMonthlyRevenueAll($query->months, $now);
        ...
        return new GetAdminRevenueChartResult(
            labels: $labels,
            revenues: $revenues,
        );
    }
