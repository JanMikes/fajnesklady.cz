...
final readonly class HandoverPhotoUploader
{
    ...
    public function uploadPhoto(UploadedFile $file, Uuid $handoverProtocolId): string
    {
        ...
        $path = 'handovers/'.$handoverProtocolId->toRfc4122().'/photos/'.$filename;
