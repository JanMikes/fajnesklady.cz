...
final readonly class OrderStatusViewModel
{
    ...
    public function __construct(
        ...
        public ?string $prolongUrl = null,
        public ?string $manualNowVariableSymbol = null,
        public ?string $manualNowBankAccount = null,
        ...
        /** @var array<string, string> Fine ID → signed invoice download URL */
        public array $fineInvoiceUrls = [],
