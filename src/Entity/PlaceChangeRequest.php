...
class PlaceChangeRequest
{
    ...
    public function __construct(
        ...
        private(set) string $requestedChanges,
        #[ORM\Column]
    ...
    public function markHandled(?string $adminNote, User $processedBy, \DateTimeImmutable $now): void
    {
        $this->status = RequestStatus::HANDLED;
    ...
    {
        return RequestStatus::HANDLED === $this->status;
    }
}
