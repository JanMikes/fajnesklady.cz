 ...
 */
final class Version20260110210648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN users.locked_until IS \'\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER failed_login_attempts SET DEFAULT 0');
